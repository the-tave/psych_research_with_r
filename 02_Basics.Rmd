...
> <i class="fa-solid fa-lightbulb" style="color: purple;"></i><i style="color: purple;">When you need help figuring out how a function works, there are several ways to get it. <br> Try typing **?"|>" ** into your console and hit enter!</i>
