...
\CommentTok{\#  $ age: int  14 12 12 14 12 13 13 13 15 14 ...}
\CommentTok{\#  $ iq : num  108.5 129.6 84.9 120.5 85.3 ...}
\CommentTok{\# \textquotesingle{}data.frame\textquotesingle{}: 20 obs. of  2 variables:}
\CommentTok{\#  $ age: int  14 13 13 13 12 15 13 13 14 13 ...}
\CommentTok{\#  $ iq : num  127.1 68.3 111.9 118.5 110.6 ...}
...
\includegraphics{_main_files/figure-html/unnamed-chunk-39-1.pdf}
...
\includegraphics{_main_files/figure-html/unnamed-chunk-74-1.pdf}
...
\begin{figure}
\includegraphics[height=0.6\textheight,class="boxshade"]{./img/MArmdex} \caption{Example Screenshot of a Thesis written in R Markdown.}\label{fig:maexample}
\end{figure}
