...
Next to missing closing parentheses, a classic source for this behavior is the so-called pipe operator, created with either `|>` (native R pipe, available since R version XXX) or `%>%` (tidyverse pipe from the `magrittr` package).
...
> <i class="fa-solid fa-lightbulb" style="color: purple;"></i><i style="color: purple;">When you need help figuring out how a function works, there are several ways to get it. Try typing **? "|>" ** into your console and hit enter!</i>

![Pobody's Nerfect [(source)](https://i1.wp.com/thegameofnerds.com/wp-content/uploads/2017/01/tumblr_ojym90eixm1si3gq6o1_540.gif?resize=540%2C302&ssl=1)](./img/nerfect.webp){#id .class width=auto height=150px}
