...
- For a broad overview of which visualization (and statistic) to use for which type of data, visit the [Statistics Picker](https://the-tave.shinyapps.io/Statistics-Picker/){target="_blank"} (currently only available in German)
