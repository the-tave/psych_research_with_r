...
```{r overallsetup, include=FALSE, warnings = FALSE}
...
In this `code chunk`, R is essentially being used as a calculator to perform basic math.
...
![Hexagon Package logos](./img/hexagons.png){#id .class width=auto height=60px}
...
<!-- ::: {.awesomeblock data-latex="[lightgray]{2pt}{\faAnchor}{teal}"} -->
...
<!-- ::: {.awesomeblock data-latex="[lightgray]{2pt}{\faBookReader}{orange}"} -->
> - [Tadaa Data: R für Psychos (german)](https://r-intro.tadaa-data.de/index.html)
> - [Intro to R](https://www.kaggle.com/code/hamelg/intro-to-r-part-4-variables) 
