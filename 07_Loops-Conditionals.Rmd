...
- They follow intuitive language:
    ...
    - **else if**: defince action for another condition
...
Brainteaser <i class="fa-solid fa-lightbulb" style="color: yellow;"></i>: What is the class() of i here?
...
Brainteaser <i class="fa-solid fa-lightbulb" style="color: yellow;"></i>: And what is the class() of i now?
...
<li>[For loops (W3 Schools)](https://www.w3schools.com/r/r_for_loop.asp/)</li>
<li>[For loops (R bloggers)](https://www.r-bloggers.com/2015/12/how-to-write-the-first-for-loop-in-r/)</li>
<li>[For loops (DataMentor)](https://www.datamentor.io/r-programming/for-loop) Here are also links the the other types of loop and a visualization</li>
<li>[Loops in R (datacamp)](https://www.datacamp.com/tutorial/tutorial-on-loops-in-r)Very thorough! :)</li>
<br>
<li>[dplyr Exercises](https://sjspielman.github.io/datascience_for_biologists/exercises/dplyr.html) Great to keep practicing over the holidays :)</li>
...
![For Loop Meme](./img/forbeep.png){#id .class width="auto" height="600px"}